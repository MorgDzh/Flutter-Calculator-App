...
class CalculationNotifier extends ChangeNotifier {
  ...
  void addNumber(String number) {
    ...
    // ! notifyListeners -> Вызывайте этот метод всякий раз, когда объект изменяется, чтобы уведомить всех клиентов, что объект мог измениться.
    notifyListeners();
  }
  ...
  void _showResult() {
    prevData = data;
    // ! interpret -> Видит строки как мат.знаки
